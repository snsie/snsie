...
> *Biomedical Engineering Educator & Developer*

![Profile Banner](https://via.placeholder.com/800x200/0d6efd/ffffff?text=Biomedical+Engineering+Educator)

## About Me

I'm a **Biomedical Engineering Educator** passionate about teaching computational skills and developing innovative software solutions for biomedical applications. My repositories showcase course materials, research tools, and programming resources I've developed throughout my career.

### Personal Background

| Category | Details |
|----------|---------|
| 🏫 Institution | University of FLorida (Department of Biomedical Engineering) |
| 🏙️ Hometown | Miami |
| 💻 First Tech Owned | Gameboy |
| 🔬 Field of Study | Biomedical Engineering with focus on machine learning |
| 📧 Contact | sns08j@ufl.edu |
...
My research combines computational methods with biomedical applications:
...
- [ ] Advanced biomedical data visualization tools
- [ ] Interactive educational modules for biomedical engineering
- [ ] Computational models for physiological systems
...
* **Tools**: Git, Docker
* **Domains**: Web Design, Biomedical Signal Processing, Image Analysis, Data Science
